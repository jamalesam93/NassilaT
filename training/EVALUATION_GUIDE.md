...
**No-go** if any Tier 2 model gate fails — keep last **GO** checkpoint on HF (currently 12B **v1.14**), diagnose in [`EVAL_GONOGO.md`](./EVAL_GONOGO.md), iterate per [`OUROBOROS_OPERATOR_MAP.md`](./OUROBOROS_OPERATOR_MAP.md).
