#!/usr/bin/env python3
"""
QLoRA fine-tuning for Nassila L3 grounding on Qwen 2.5 3B Instruct.

Base model: Qwen/Qwen2.5-3B-Instruct
Fine-tunes the 3B parameter model with ChatML template for Sanad grounding.

Usage:
  python scripts/train_qlora_qwen3b.py \
    --train-file data/l3_grounding_train_v114.jsonl \
    --output-dir outputs/nassila-sanad-qwen25-3b-v1
"""
...
DEFAULT_OUTPUT_DIR = TRAINING_DIR / "outputs" / "nassila-sanad-qwen35-4b-v1"
...
def train_qwen_peft(
    ...
    print("Starting QLoRA training on Qwen 2.5 3B...")
    trainer.train()
...
def main() -> int:
    parser = argparse.ArgumentParser(description="QLoRA for Nassila grounding on Qwen 2.5 3B")
    ...
    print(f"Starting Qwen 2.5 3B QLoRA fine-tuning (Base: {args.base_model})")
