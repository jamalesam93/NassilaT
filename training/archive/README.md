# Archived training docs

Completed or superseded walkthroughs, recovery plans, and historical guides. **Do not start new work from these files.**
...
| File | Era | Outcome |
|------|-----|---------|
| PHASE1_VAST_4090_WALKTHROUGH.md | Phase 1 smoke | Complete |
| PHASE2_7_V1_4_WALKTHROUGH.md | v1.4a adapter | Tier 1 checkpoint |
...
| V112_RECOVERY_PLAN.md | v1.12 recovery spec | → E4B v1.12 GO |
| PHASE2_11_V112_WALKTHROUGH.md | v1.12 E4B Vast | GO |
| PHASE2_12_12B_QUALITY_WALKTHROUGH.md | v1.12 12B Vast | Tier 2 PASS |
| PHASE2_13_12B_MULTI_CLAIM_WALKTHROUGH.md | v1.13 12B boost | **NO-GO** — JSON/quote regression |
