...
| **Quality** | `nassila-sanad-12b` | Gemma 4 12B Q6_K | **Tier 2** (`tier2_gates`) | **Main quality tier** — v1.14 selected (v1.12 higher-combined fallback) |

**Operator instances:** E4B v1.12 on **A6000 ~100 GB**; 12B v1.14 on **A100 80GB+ / ≥200–500 GB disk**. **Local smoke validated** on RTX 4060 8 GB (2026-06-21).
...
# Instance 2 — A100: 12B v1.12 quality (Tier 2 PASS reference)
ARM=12b PHASE=12 MULTI_SEED=1 bash training/scripts/run_ab_pilot_pipeline.sh

# Instance 3 — A100: 12B v1.14 multi_claim (selected quality checkpoint)
